...
"""
S1 v4: Scout Player Rating System — 이력 피처 강화 (Actions 실행 대상)
=========================================================================

v1.2 → v4 개선:
- war_lag1: 직전 시즌 war_rating (가장 강력한 예측 변수)
- war_lag1_diff: 전년 대비 war 변화량 (성장/하락 추세)
- is_big6: 빅6 팀 소속 플래그 (Arsenal/Chelsea/Liverpool/ManCity/ManUtd/Spurs)
- epl_experience: EPL 경험 시즌 수
- age_sq: 나이 제곱 (peak-decline 비선형)
- XGBoost: n=500, early_stopping=30, lr=0.03
목표: XGBoost test R² 0.4867 → ≥ 0.55
"""

...
# ─────────────────────────────────────────────
# 22. decline_predictions_v3.parquet 저장
# ─────────────────────────────────────────────
print("\n[14] decline_predictions_v3.parquet 저장...")
output_cols = [
    'player_key', 'team', 'pos_group', 'age', 'season_year',
...
merged[output_cols].to_parquet(SCOUT_DIR / 'decline_predictions_v3.parquet', index=False)
...
print(f"  {SCOUT_DIR}/decline_predictions_v3.parquet")
